...
---
Далее следует запустить скрипт `script/run.sh` чтобы собрать образ и оправить его на ваш удаленный репозиторий.
...
---
![Проверка ручки GET - провеал](pictures/GetWrong.png)
